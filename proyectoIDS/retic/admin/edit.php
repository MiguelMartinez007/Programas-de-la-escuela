    ...
    function editsubject($subject){ ?>
        ...
        <div class="modal-body">
            ...
            <form action="data/data_model.php?q=updatesubject&id=<?php echo $row['id'];?>" method="post">
				...
				<div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $row['clave_inter']; ?>" name="clave_inter" placeholder="subject title" />
                </div>
				<div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $row['hrs']; ?>" name="hrs" placeholder="subject title" />
                </div>
				<div class="form-group">
                    <input type="text" class="form-control" value="<?php echo $row['semestre']; ?>" name="semestre" placeholder="subject title" />
                </div>
        </div>
        <div class="modal-footer">
            <a href="subject.php"><button type="button" class="btn btn-default"><i class="fa fa-arrow-left"></i> Volver</button></a>
